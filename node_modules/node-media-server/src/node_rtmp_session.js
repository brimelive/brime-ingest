...
class NodeRtmpSession {
  ...
  async onPublish(invokeMessage) {
    ...
    if(typeof this.config.rtmp?.auth_callback === "function" && await this.config.rtmp.auth_callback({id: this.id, streamPath: this.publishStreamPath, args: this.publishArgs}) === false) return this.reject()
